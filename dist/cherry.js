      ...
      case 0:
        switch (y) {
          ...
          case 59:
            w += ";";
          default:
            if (Ke(E = Br(w, t, r, f, h, i, l, S, R = [], A = [], g, a), a), y === 123)
              if (h === 0)
                yt(w, t, E, E, R, a, g, l, A);
              else
      ...
      default:
        ...
        switch (w += pr(y), y * m) {
          ...
          case 44:
            ...
            break;
          case 64:
            Ee() === 45 && (w += zt(oe())), b = Ee(), h = g = ie(S = w += Qo(gt())), y++;
            break;
          case 45:
            j === 45 && ie(w) == 2 && (m = 0);
        }
...
function Bi(e) {
  ...
  var s = function(c) {
    var f = $t(), h = M.useContext(We), g = M.useRef(f.styleSheet.allocateGSInstance(i)).current;

        ...
        if (e.length)
          return Go(r = e.props, function(i) {
            switch (le(i, n = /(::plac\w+|:read-\w+)/)) {
              case ":read-only":
              case ":read-write":
                Ne(ye(e, { props: [_(i, /:(read-\w+)/, ":" + Ze + "$1")] })), Ne(ye(e, { props: [i] })), tr(e, { props: Br(r, n) });
                break;
              case "::placeholder":
                Ne(ye(e, { props: [_(i, /:(plac\w+)/, ":" + L + "input-$1")] })), Ne(ye(e, { props: [_(i, /:(plac\w+)/, ":" + Ze + "$1")] })), Ne(ye(e, { props: [_(i, /:(plac\w+)/, z + "input-$1")] })), Ne(ye(e, { props: [i] })), tr(e, { props: Br(r, n) });
                break;
            }
            return "";
          });
  ...
  return e.prototype.generateAndInjectStyles = function(t, r, n) {
    ...
    if (this.isStatic && !n.hash)
      if (this.staticRulesId && r.hasNameForId(this.componentId, this.staticRulesId))
        ...
        var a = $t(me(this.rules, t, r, n)), s = ir(_e(this.baseHash, a) >>> 0);
...
function Wi(e, t, r) {
  ...
  function y(R, A) {
    return function(E, $, X) {
      ...
      var Ve = Sn($, ve, jt) || Fe, J = function(Te, se, he) {
      ...
      for (var V in J)
        J[V] === void 0 || V[0] === "$" || V === "as" || V === "theme" && J.theme === Ve || (V === "forwardedAs" ? pe.as = J.forwardedAs : Ce && !Ce(V, fe) || (pe[V] = J[V], Ce || process.env.NODE_ENV !== "development" || Fo(V) || tn.has(V) || !or.has(fe) || (tn.add(V), console.warn('styled-components: it looks like an unknown prop "'.concat(V, '" is being sent through to the DOM, which will likely trigger a React console error. If you would like automatic filtering of unknown props, you can opt-into that behavior via `<StyleSheetManager shouldForwardProp={...}>` (connect an API like `@emotion/is-prop-valid`) or consider using transient props (`$` prefix for automatic filtering.)')))));
      ...
      var Ge = ke(tt, Z);
      return je && (Ge += " " + je), J.className && (Ge += " " + J.className), pe[Ft(fe) && !or.has(fe) ? "class" : "className"] = Ge, pe.ref = X, yo(fe, pe);
    }(S, R, A);
  }
  y.displayName = g;
...
var Bi = function() {
  ...
  return e.prototype.createStyles = function(t, r, n, i) {
    var a = i($t(me(this.rules, r, n, i)), ""), s = this.componentId + t;
    n.insertRules(s, s, a);

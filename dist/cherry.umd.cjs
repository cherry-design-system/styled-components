...
`;function Ni({children:e,theme:t}){const r=wn(t);return $.jsxs(di,{theme:t,children:[$.jsx(r,{}),e]})}const zi=F.div`
	margin: auto;
	width: 100%;
...
`;function Cn({theme:e=Be,...t}){return $.jsx(zi,{...t,theme:e,children:t.children})}const Di=F(Cn)`
	background: ${({theme:e})=>e.colors.light};
	border-radius: ${({theme:e})=>e.spacing.radius.lg};
	border: solid 1px ${({theme:e})=>e.colors.grayLight};
`;function Mi({theme:e=Be,...t}){return $.jsx(Di,{...t,theme:e,children:t.children})}const Rn=(e,t,r,n,i,a)=>R`
	${de};
	font-family: inherit;
...
`;function Bi({theme:e=Be,...t}){return $.jsx(Wi,{...t,theme:e,children:t.children})}const qi=F.div`
	display: flex;
...
`;function Vi({theme:e=Be,...t}){return $.jsx(qi,{...t,theme:e,children:t.children})}const Gi=F.div`
	display: grid;
...
`;function Yi({theme:e=Be,...t}){return $.jsx(Gi,{...t,theme:e,children:t.children})}const qe=F.span`
	display: inline-flex;
...
`,ra=F.input`
	...
	${({$size:e})=>e==="big"?`
				...
				`}
`;function na({...e}){return $.jsxs(ta,{$fullWidth:e.$fullWidth,children:[e.$label&&$.jsx(Ie,{htmlFor:e.id,children:e.$label}),$.jsx(ra,{...e,type:"range"})]})}const oa=F.select`
	${de};
	${Rt};
	font-family: inherit;
	display: inline-block;
...
`;function ia({...e}){return $.jsxs(qe,{$fullWidth:e.$fullWidth,children:[e.$label&&$.jsx(Ie,{htmlFor:e.id,children:e.$label}),$.jsxs(Pn,{$fullWidth:e.$fullWidth,children:[$.jsx(oa,{...e,children:e.children}),$.jsx(_n,{})]})]})}const Tn=(e,t)=>t?`display: inline-block;
			max-height: 0;
			min-width: ${e}px;
...
`;function ca({...e}){return $.jsx(sa,{...e})}const la=F.textarea`
	...
	${({$fullWidth:e})=>ve(!!e)}
`;function ua({...e}){return $.jsxs(qe,{$fullWidth:e.$fullWidth,children:[e.$label&&$.jsx(Ie,{htmlFor:e.id,children:e.$label}),$.jsx(la,{...e,children:e.children})]})}const da=F.span`
	display: inline-block;
	margin: auto 0;
	position: relative;
...
`;function ha({type:e="checkbox",...t}){return $.jsxs(qe,{$fullWidth:t.$fullWidth,children:[$.jsxs(da,{children:[$.jsx(pa,{...t,type:e}),$.jsx(fa,{$error:t.$error,$success:t.$success,className:"fake-toggle",$size:t.$size})]}),t.$label&&$.jsx(Ie,{htmlFor:t.id,children:t.$label})]})}p.Box=Mi,p.Button=Fi,p.CherryThemeProvider=Ni,p.Col=Bi,p.Container=Cn,p.Flex=Vi,p.GlobalStyles=wn,p.Grid=Yi,p.IconArrow=_n,p.IconCheck=$n,p.Input=Ji,p.MaxWidth=ea,p.Range=na,p.Select=ia,p.Space=ca,p.StyledComponentsRegistry=yi,p.StyledIconWrapper=Pn,p.StyledInputWrapper=qe,p.StyledLabel=Ie,p.Textarea=ua,p.Toggle=ha,p.breakpoints=Ct,p.buttonStyles=Rn,p.colors=kn,p.colorsDark=En,p.fontSizes=yr,p.fonts=gr,p.formElementHeightStyles=Ot,p.fullWidthStyles=ve,p.generateColSpanStyles=we,p.generateColsStyles=Se,p.generateGapStyles=K,p.generateJustifyContentStyles=_e,p.generatePaddingStyles=$e,p.lineHeights=mr,p.mq=z,p.resetButton=de,p.resetInput=Rt,p.shadows=hr,p.spacing=pr,p.statusBorderStyles=xe,p.styledBlockquote=Pi,p.styledButton=ji,p.styledButtonBig=Ai,p.styledCode=Ti,p.styledH1=Si,p.styledH2=wi,p.styledH3=$i,p.styledH4=_i,p.styledH5=ki,p.styledH6=Ei,p.styledHero1=bi,p.styledHero2=vi,p.styledHero3=xi,p.styledInput=Ii,p.styledInputBig=Li,p.styledSmall=Oi,p.styledStrong=Ri,p.styledText=Ci,p.theme=Be,p.themeDark=mi,Object.defineProperty(p,Symbol.toStringTag,{value:"Module"})});

...
Example:
  ...
  <Component />`),_=!0,w={}}}})(l,y)),Or(b,function(){return".".concat(b.styledComponentId)}),a&&io(b,e,{attrs:!0,componentStyle:!0,displayName:!0,foldedComponentIds:!0,shouldForwardProp:!0,styledComponentId:!0,target:!0}),b}function Eo(e,t){for(var r=[e[0]],n=0,o=t.length;n<o;n+=1)r.push(t[n],e[n+1]);return r}var xo=function(e){return Object.assign(e,{isCss:!0})};function $(e){for(var t=[],r=1;r<arguments.length;r++)t[r-1]=arguments[r];if(Ce(e)||Fe(e))return xo(ve(Eo($t,ke([e],t,!0))));var n=e;return t.length===0&&n.length===1&&typeof n[0]=="string"?ve(n):xo(ve(Eo(n,t)))}function $r(e,t,r){if(r===void 0&&(r=Be),!t)throw ee(1,t);var n=function(o){for(var a=[],i=1;i<arguments.length;i++)a[i-1]=arguments[i];return e(t,r,$.apply(void 0,ke([o],a,!1)))};return n.attrs=function(o){return $r(e,t,Y(Y({},r),{attrs:Array.prototype.concat(r.attrs,o).filter(Boolean)}))},n.withConfig=function(o){return $r(e,t,Y(Y({},r),o))},n}var Ro=function(e){return $r(bi,e)},X=Ro;Er.forEach(function(e){X[e]=Ro(e)});var _i=(function(){function e(t,r){this.rules=t,this.componentId=r,this.isStatic=_o(t),rt.registerId(this.componentId+1)}return e.prototype.createStyles=function(t,r,n,o){var a=o(jt(ve(this.rules,r,n,o)),""),i=this.componentId+t;n.insertRules(i,i,a)},e.prototype.removeStyles=function(t,r){r.clearRules(this.componentId+t)},e.prototype.renderStyles=function(t,r,n,o){t>2&&rt.registerId(this.componentId+t);var a=this.componentId+t;this.isStatic?n.hasNameForId(a,a)||this.createStyles(t,r,n,o):(this.removeStyles(t,n),this.createStyles(t,r,n,o))},e})();function vi(e){for(var t=[],r=1;r<arguments.length;r++)t[r-1]=arguments[r];var n=$.apply(void 0,ke([e],t,!1)),o="sc-global-".concat(Jn(JSON.stringify(n))),a=new _i(n,o);process.env.NODE_ENV!=="production"&&Gn(o);var i=new WeakMap,s=function(u){var d=Ht(),p=ne?void 0:x.useContext(Xe),l=i.get(d.styleSheet);if(l===void 0&&(l=d.styleSheet.allocateGSInstance(o),i.set(d.styleSheet,l)),process.env.NODE_ENV!=="production"&&x.Children.count(u.children)&&console.warn("The global style component ".concat(o," was given child JSX. createGlobalStyle does not render children.")),process.env.NODE_ENV!=="production"&&n.some(function(P){return typeof P=="string"&&P.indexOf("@import")!==-1})&&console.warn("Please do not use @import CSS syntax in createGlobalStyle at this time, as the CSSOM APIs we use in production do not handle it well. Instead, we recommend using a library such as react-helmet to inject a typical <link> meta tag to the stylesheet, or simply embedding it manually in your index.html <head> section for a simpler app."),(typeof window>"u"||!d.styleSheet.server)&&(function(P,k,C,b,R){if(a.isStatic)a.renderStyles(P,Ha,C,R);else{var A=Y(Y({},k),{theme:Yn(k,b,s.defaultProps)});a.renderStyles(P,A,C,R)}})(l,u,d.styleSheet,p,d.stylis),!ne){var y=x.useRef(!0);x.useLayoutEffect(function(){return y.current=!1,function(){y.current=!0,queueMicrotask(function(){y.current&&(a.removeStyles(l,d.styleSheet),typeof document<"u"&&document.querySelectorAll('style[data-styled-global="'.concat(o,'"]')).forEach(function(P){return P.remove()}))})}},[l,d.styleSheet])}if(ne){var v=o+l,T=typeof window>"u"?d.styleSheet.getTag().getGroup(Ue(v)):"";if(T){var m="".concat(o,"-").concat(l);return x.createElement("style",{key:m,"data-styled-global":o,precedence:"styled-components",href:m,children:T})}}return null};return x.memo(s)}var Ei=(function(){function e(){var t=this;this._emitSheetCSS=function(){var r=t.instance.toString();if(!r)return"";var n=Pr(),o=jt([n&&'nonce="'.concat(n,'"'),"".concat(ye,'="true"'),"".concat(Nt,'="').concat(qe,'"')].filter(Boolean)," ");return"<style ".concat(o,">").concat(r,"</style>")},this.getStyleTags=function(){if(t.sealed)throw ee(2);return t._emitSheetCSS()},this.getStyleElement=function(){var r;if(t.sealed)throw ee(2);var n=t.instance.toString();if(!n)return[];var o=((r={})[ye]="",r[Nt]=qe,r.dangerouslySetInnerHTML={__html:n},r),a=Pr();return a&&(o.nonce=a),[x.createElement("style",Y({},o,{key:"sc-0-0"}))]},this.seal=function(){t.sealed=!0},this.instance=new rt({isServer:!0}),this.sealed=!1}return e.prototype.collectStyles=function(t){if(this.sealed)throw ee(2);return x.createElement(po,{sheet:this.instance},t)},e.prototype.interleaveWithNodeStream=function(t){throw ee(3)},e})();process.env.NODE_ENV!=="production"&&typeof navigator<"u"&&navigator.product==="ReactNative"&&console.warn(`It looks like you've imported 'styled-components' on React Native.
...
`;function Xi({theme:e=Ge,...t},r){return S.jsx(Wi,{...t,theme:e,ref:r,children:t.children})}const Gi=x.forwardRef(Xi),$o=(e,t,r,n,o,a)=>$`
  ${de};
  font-family: inherit;
  display: inline-flex;
  padding: 15px 30px;
  ...
  `}
	...
	${o&&"width: 100%;"}
`,Yi=X.button`
  ${({theme:e,$variant:t,$size:r,$outline:n,$fullWidth:o,disabled:a})=>$o(e,t,r,n,o,a)}
...
`,ms=X.input`
  ...
  ${({$fullWidth:e})=>fe(!!e)}
	...
	${({$size:e})=>e==="big"?`
				...
				`}
`;function bs({...e},t){return S.jsxs(ys,{$fullWidth:e.$fullWidth,className:e.$wrapperClassName,children:[e.$label&&S.jsx(je,{htmlFor:e.id,children:e.$label}),S.jsx(ms,{...e,type:"range",ref:t})]})}const _s=x.forwardRef(bs),vs=X.select`
  ${de};
  ${Bt};
  font-family: inherit;
  display: inline-block;
...
`,Io=X.span`
  ...
  `;function Es({...e},t){return S.jsxs(Ye,{$fullWidth:e.$fullWidth,$label:e.$label,className:e.$wrapperClassName,children:[e.$label&&S.jsx(je,{htmlFor:e.id,children:e.$label}),S.jsxs(Io,{$fullWidth:e.$fullWidth,children:[S.jsx(vs,{...e,ref:t,children:e.children}),S.jsx(To,{})]})]})}const xs=x.forwardRef(Es),Lo=(e,t)=>t?`display: inline-block;
			max-height: 0;
			min-width: ${e}px;
...
`;function Ss({...e},t){return S.jsx(ws,{...e,ref:t})}const Ts=x.forwardRef(Ss),Os=X.textarea`
  ...
  ${({$error:e,$success:t,theme:r})=>Ee(!!e,!!t,r)}
	...
	${({$fullWidth:e})=>fe(!!e)}
`;function Ps({...e},t){return S.jsxs(Ye,{$fullWidth:e.$fullWidth,$label:e.$label,className:e.$wrapperClassName,children:[e.$label&&S.jsx(je,{htmlFor:e.id,$label:e.$label,children:e.$label}),S.jsx(Os,{...e,ref:t,children:e.children})]})}const As=x.forwardRef(Ps),ks=X.span`
  display: inline-block;
  margin: auto 0;
  position: relative;
  vertical-align: middle;
...
`;function Cs({type:e="checkbox",...t},r){return S.jsxs(Ye,{$fullWidth:t.$fullWidth,$label:t.$label,className:t.$wrapperClassName,children:[S.jsxs(ks,{children:[S.jsx(Ds,{...t,type:e,ref:r}),S.jsx(Ns,{$error:t.$error,$success:t.$success,className:"fake-toggle",$size:t.$size})]}),t.$label&&S.jsx(je,{htmlFor:t.id,children:t.$label})]})}const $s=x.forwardRef(Cs);E.Box=Gi,E.Button=Ki,E.CherryThemeProvider=Bi,E.Col=Zi,E.Container=Co,E.Flex=rs,E.GlobalStyles=wo,E.Grid=as,E.IconArrow=To,E.IconCalendar=Oo,E.IconCheck=So,E.Input=ds,E.MaxWidth=gs,E.Range=_s,E.Select=xs,E.Space=Ts,E.StyledComponentsRegistry=xi,E.StyledIconWrapper=Io,E.StyledInputWrapper=Ye,E.StyledLabel=je,E.Textarea=As,E.ThemeContext=Do,E.Toggle=$s,E.breakpoints=qt,E.buttonStyles=$o,E.colors=Po,E.colorsDark=Ao,E.fontSizes=Lr,E.fonts=Ir,E.formElementHeightStyles=Ft,E.fullWidthStyles=fe,E.generateColSpanStyles=Re,E.generateColsStyles=xe,E.generateGapStyles=J,E.generateJustifyContentStyles=Se,E.generatePaddingStyles=we,E.lineHeights=Mr,E.mq=L,E.resetButton=de,E.resetInput=Bt,E.shadows=ko,E.shadowsDark=No,E.spacing=jr,E.statusBorderStyles=Ee,E.styledBlockquote=Ii,E.styledButton=Mi,E.styledButtonBig=Hi,E.styledCode=Li,E.styledH1=Oi,E.styledH2=Pi,E.styledH3=Ai,E.styledH4=ki,E.styledH5=Ni,E.styledH6=Di,E.styledHero1=wi,E.styledHero2=Si,E.styledHero3=Ti,E.styledInput=zi,E.styledInputBig=qi,E.styledSmall=ji,E.styledStrong=$i,E.styledText=Ci,E.theme=Ge,E.themeDark=Ri,Object.defineProperty(E,Symbol.toStringTag,{value:"Module"})}));
